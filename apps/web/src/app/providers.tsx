...
export function Providers({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // Only import wallet libraries in browser environment
  ...
  // During SSR or before wallet providers load, render without them
  ...
  // After mount and wallet providers are loaded
